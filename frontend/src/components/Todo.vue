  ...
  <div class="jumbotron vertical-center">
    <div class="container text-center">
      <span class="lead display-3"
        >To-Do <i class="fa fa-file-text" style="color: royalblue"></i
      ></span>
      <br />
                  ...
                  <div class="modal-body">
                    <form>
                      ...
                      <div class="mt-2 form-check">
                        <input
                          id="played"
                          v-model="updatedData.isCompleted"
                          type="checkbox"
                          class="form-check-input"
                        />
                        <label class="form-check-label" for="played"
...
export default {
  ...
  methods: {
    ...
    deleteTask(id) {
      ...
      axios.post(deleteUrl, { id: id }).then((res) => {
        console.log(res);
      });
    },
    ...
    updateTask() {
      ...
      axios
        .post(updateUrl, this.updatedData)
        .then((res) => {
          console.log(res);
        })
        .catch((err) => {
